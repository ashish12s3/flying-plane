...
public class MyWindow extends Table {
    ...
    Table buttonTable;
    private Color mColor = Color.valueOf("00000023");
    private static Color tmp = Color.CLEAR;
    ...
    public void addActorAfter(Actor actorAfter, Actor actor) {
        table.addActorAfter(actorAfter, actor);
    }

    @Override
    public void addActorBefore(Actor actorBefore, Actor actor) {
        table.addActorBefore(actorBefore, actor);
    }
    ...
    public void draw(Batch batch, float parentAlpha) {
        ...
        if (style.stageBackground != null) {
            ...
            if (Gdx.graphics.isGL30Available()) {
                Gdx.gl30.glClearColor(mColor.r, mColor.g, mColor.b, mColor.a);
            } else
    ...
    protected void drawBackground(Batch batch, float parentAlpha, float x, float y) {
        ...
        if (titleCache != null) {
            ...
            if ((titleAlignment & Align.left) != 0)
                ...
                x += width - titleCache.getLayouts().first().width - getPadRight();
            else
                x += (width - titleCache.getLayouts().first().width) / 2;
            if ((titleAlignment & Align.top) == 0) {
                if ((titleAlignment & Align.bottom) != 0)
                    y -= padTop - titleCache.getLayouts().first().height;
                else
                    y -= (padTop - titleCache.getLayouts().first().height) / 2;
            }
    ...
    /**
     * The style for a window, see {@link MyWindow}.
     *
     * @author Nathan Sweet
     */
